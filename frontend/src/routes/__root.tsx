...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Premium industrial electrical distributor. Circuit breakers, drives, PLCs, and switchgear engineered for the world's most demanding infrastructure." },
      { property: "og:title", content: "VOLTCORE — Industrial Electrical Components" },
      { property: "og:description", content: "Premium industrial electrical distributor. Engineered for uptime. Certified for scale." },
